...
# ============================================================
# 🧠 PRODUCT INTELLIGENCE PLATFORM — CORE ENGINE
...
def train_models(df):
    ...
    reg.fit(X_train, df["ventas_unidades"])
    ...
    mae = mean_absolute_error(df["ventas_unidades"], reg.predict(X))
...
with tab_ins:
    ...
    with d2:
        ...
        st.bar_chart(bins2.value_counts().sort_index())
